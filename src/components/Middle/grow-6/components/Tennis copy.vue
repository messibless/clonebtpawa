...
<template>
    <div data-v-5cd8c607="" data-v-fc0cbc39="" class="events" data-test-id="tag-Events" data-test-class="cmsTag">
        <div data-v-4310f641="" data-v-5cd8c607="" class="game-category" info-category-id="">
            ...
            <div data-v-34ba8927="" v-for="game in tennis" :key="game.id" data-v-4310f641=""
                class="game-events-container prematch" data-test-id="bpEvent" data-event-id="33211412"> <a
                    data-v-34ba8927="" href="/event/33211412" class="game-event-wrapper pointer"
                    data-test-id="nav-event-33211412-link" name="id-33211412">
                    <div data-v-34ba8927="" class="game-event-header">
                        <div data-v-34ba8927="" class="game-event-header-left-content">{{ formatTime(game.time) }} <span
                                data-v-34ba8927="" class="game-event-date">{{ formatDate(game.date) }}</span></div>
                    ...
                    <div data-v-34ba8927="" class="game-scoreboard">
                        <div data-v-9e211631="" data-v-34ba8927="" class="scoreboard-period invert">
                            <div data-v-9e211631="" class="scoreboard-period-participant-name-wrapper"><span
                                    data-v-9e211631="" class="scoreboard-period-participant-name">{{ game.homeTeam
                                    }}</span> <!----></div>
                            <div data-v-9e211631="" class="scoreboard-period-participant-name-wrapper"><span
                                    data-v-9e211631="" class="scoreboard-period-participant-name">{{ game.awayTeam
                                    }}</span>
                                <!---->
                            </div>
                        </div>
