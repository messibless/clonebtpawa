  ...
  <form @submit.prevent="handleRegister" class="join-now">
    ...
    <div class="country-code-container" data-test-id="joinNowPhoneNumber">
      <div class="input-field phone-number-input">
        ...
        <div class="help-text">
          <!-- {{ isPhoneValid ? '✓ Valid phone number' : 'Enter your phone number without the country code (e.g., 123456789).' }} -->
    ...
    <div class="input-field" autocomplete="new-password">
      ...
      <!-- <div class="help-text">
        {{ password.length }}/4  Characters {{ isPasswordValid ? '✓' : '' }}
      </div> -->
      <div class="help-text">
        Min. 4 Characters
      </div>
...
/* ===== STYLES ZA FORM TU - KUTOKA JOIN PAGE ===== */
...
.input-field-wrapper input {
  ...
  /* Consistent padding regardless of type */
  padding: 7px 10px;
  ...
  transition: none; /* Remove transitions that might cause shift */
}
