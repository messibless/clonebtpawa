...
const handleLogin = async (e) => {
  ...
  setTimeout(() => {
    // Check credentials
    if (phoneNumber.value === validUser.phoneNumber && password.value === validUser.password) {
      // Store authentication data
      if (keepLoggedIn.value) {
        localStorage.setItem('authToken', 'dummy_jwt_token_' + Date.now())
        localStorage.setItem('userData', JSON.stringify(validUser))
      } else {
        sessionStorage.setItem('authToken', 'dummy_jwt_token_' + Date.now())
        sessionStorage.setItem('userData', JSON.stringify(validUser))
      }
...
const fillValidCredentials = () => {
  phoneNumber.value = validUser.phoneNumber
  ...
  <div class="page login-page router-view">
    <div class="tabs square with-top-border auth-tabs">
      ...
      <ul class="tabs-menu align-center">
        ...
        <li class="last tabs-selector" data-test-id="tabs-join-now">
          <div class="tab-item">
            <div class="tab-item-border">
              <div class="tab-icon">
                <svg class="svg-icon icon icon-size-medium">
          ...
          <form @submit.prevent="handleLogin" class="login-form">
            ...
            <span class="join-now-text">
              ...
              <a 
                ...
                @click.prevent="console.log('Join Now clicked')"
              >
                Join Now
              </a>
            </span>
            ...
            <div class="quick-fill">
              ...
              >
                Fill Valid Credentials (Phone: {{ validUser.phoneNumber }})
              </button>
            </div>
          </form>
        </div>
